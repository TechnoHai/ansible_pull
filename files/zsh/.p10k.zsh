# Generated by Powerlevel10k configuration wizard on 2024-03-13 at 09:35 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 04117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, blurred heads, blurred tails, 2 lines, solid, full frame,
# dark-ornaments, sparse, many icons, fluent, instant_prompt=auto-quiet.
